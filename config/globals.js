...
module.exports.globals = {
  ...
  // To use the latest release of Lodash, run `npm install lodash --save` and require it in the file(s)
  // where you need it.  Or, to expose it as a global, change this line to say `require('lodash')`
  // (instead of `false`).
  _: false,
